...
public class Request_getUpdates implements API_REQUEST {
    @Override
    public void send() {
        try {
            ...
            Main.LogManager.log(System.Logger.Level.INFO, "Sending request getUpdates to Telegram server.");
            ...
            switch (reply_message.statusCode()) {
                ...
                case 200 -> LockedStates.UPDATE = JsonParser.parseString(reply_message.body());
